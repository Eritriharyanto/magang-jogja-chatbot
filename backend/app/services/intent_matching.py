...
GREETING_WORDS = [
    "halo", "hallo", "haloo", "halooo", "hallow", "helo", "hello",
    "hai", "haii", "haiii", "hi", "hii", "hey", "heyy", "hei", "heii",
    "pagi", "siang", "sore", "malam",
    "met pagi", "met siang", "met sore", "met malam",
    "pagi min", "siang min", "sore min", "malam min",
    "selamat pagi", "selamat siang", "selamat sore", "selamat malam",
    "selamat datang", "salam kenal", "met kenal",
    "assalamualaikum", "assalamu'alaikum", "aslkm", "askum",
    "wassalamualaikum", "waalaikumsalam", "waalaikumsalam wr wb",
    "permisi", "permisi min", "permisi kak", "permisi gan",
    "numpang tanya", "mau tanya", "mau nanya", "mo nanya",
    "izin tanya", "izin nanya", "izin bertanya",
    "min", "mimin", "kak", "kk", "ka", "gan", "bro", "sis", "bang", "kaka",
    "admin", "min admin", "cs", "min cs",
    "woy", "woi", "woii", "woyy",
    "test", "tes", "tes min", "coba tes", "tes chat",
    "halo min", "halo kak", "halo gan", "halo admin", "halo cs",
    "ada orang", "ada min", "min ada", "ada admin gak", "ada yang jaga gak",
    "masih online", "masih aktif", "respon dong", "respon min",
    "chat pertama", "mulai chat", "buka obrolan",
]
...
STATIC_INTENT_KEYWORDS = [
    ("tanya_daftar_posisi", [
        ...
        "semua formasi magang", "posisi magang buat mahasiswa apa aja",
        "posisi yang tersedia", "posisi yang dibuka", "lowongan magang apa aja",
        "lowongan apa aja", "ada posisi apa aja", "posisinya apa aja",
        "bidang apa aja yang dibuka", "list posisi magang",
        "daftar lowongan magang", "posisi magang tersedia",
        "formasi yang dibuka", "formasi apa aja yang ada",
        "ada divisi apa aja", "divisi yang tersedia",
        "bagian-bagian magang", "kategori posisi magang",
        "opsi posisi magang", "pilihan posisi magang",
        "posisi yang ditawarkan", "magang di bagian apa aja",
    ]),
    ("tanya_syarat_pendaftaran", [
        ...
        "apa aja syaratnya", "syarat-syaratnya apa", "syarat buat daftar",
        "syarat masuk magang", "persyaratan magang", "persyaratan pendaftaran",
        "syarat pendaftaran magang", "kriteria pendaftaran",
        "kualifikasi pendaftaran", "harus punya apa buat daftar",
        "yang harus disiapin buat daftar", "wajib punya cv",
        "wajib ada surat pengantar", "minimal ipk berapa", "ipk minimal",
        "kriteria peserta magang", "syarat administrasi",
    ...
    ("tanya_cara_daftar", [
        ...
        "cara ikutan magang", "gimana cara ikut", "gimana daftarnya",
        "cara apply", "cara ngelamar", "cara ngelamar magang",
        "gimana proses daftarnya", "urutan daftar gimana",
        "tahapan pendaftaran", "tahapan seleksi", "prosedur pendaftaran",
        "flow pendaftaran", "step daftar magang", "link pendaftaran dimana",
        "form pendaftaran dimana", "daftar via apa", "daftarnya online apa offline",
        "gimana step-stepnya daftar",
    ]),
    ("tanya_durasi_magang", [
        ...
        "magang 6 bulan",
        "berapa lama magangnya", "magang berapa bulan", "lama magang berapa bulan",
        "durasinya berapa lama", "magang cuma sebulan bisa gak",
        "bisa magang setahun gak", "waktu magang fleksibel gak",
        "magang bisa disesuaikan gak", "batas waktu magang",
        "jangka waktu magang", "periode magang", "magang berapa minggu",
    ]),
    ("tanya_sistem_kerja", [
        ...
        "kerja dari rumah bisa gak", "harus ke kantor tiap hari",
        "sistem kerjanya kayak gimana", "kerjanya full wfo", "kerjanya full wfh",
        "ada opsi hybrid gak", "boleh kerja dari kos", "boleh kerja dari luar kota",
        "wajib hadir fisik", "harus dateng ke lokasi", "kerja remote bisa gak",
        "boleh kerja jarak jauh",
    ]),
    ("tanya_lokasi_magang", [
        ...
        "posisinya di kota mana", "penempatannya dimana aja", "cuma di jogja doang",
        "bisa di luar jogja gak", "lokasi kantornya dimana",
        "titik lokasinya dimana", "maps lokasinya dimana", "penempatan magang dimana",
    ]),
    ("tanya_target_peserta", [
        ...
        "yang boleh daftar siapa aja", "siapa aja yang bisa ikut",
        "batasan usia peserta", "usia minimal daftar",
        "khusus mahasiswa apa umum", "buat pelajar bisa gak",
        "buat anak kuliah aja apa smk juga", "gap year boleh daftar gak",
        "lulusan smk boleh gak", "anak kuliah semester berapa boleh daftar",
    ]),
    ("tanya_fasilitas_benefit", [
        ...
        "apa aja yang didapat", "keuntungan ikut magang", "benefit magang apa aja",
        "yang bakal didapat peserta", "hak peserta magang",
        "apa yang disediakan buat peserta", "fasilitas buat anak magang",
        "fasilitas apa aja yang dikasih",
    ]),
    ("tanya_sertifikat", [
        "sertifikat", "syarat dapet sertifikat", "sertifikatnya dikasih kapan",
        "sertifikat magang bisa dipake buat syarat kuliah",
        "dikasih sertifikat gak", "ada sertifikatnya gak", "sertifikat resmi gak",
        "bentuk sertifikatnya kayak gimana", "sertifikat buat lamaran kerja",
        "sertifikat diakui gak", "sertifikatnya digital apa fisik",
    ]),
    ("tanya_biaya_pendaftaran", [
        ...
        "ada biaya pendaftaran gak", "bayar berapa buat daftar",
        "berbayar apa gratis", "gratis kan daftarnya", "ada pungutan biaya gak",
        "ada biaya tersembunyi gak",
    ]),
    ("tanya_kontak_admin", [
        ...
        "kontak", "nomer hp admin", "hp admin", "line admin", "sosmed admin",
        "ig admin", "akun instagram admin", "dm instagram", "chat cs",
        "hubungi cs", "customer service", "telepon admin", "no hp admin",
        "narahubung", "kontak person", "cara menghubungi",
        "mau nanya langsung ke admin", "minta kontak", "boleh minta kontaknya",
    ]),
    ("tanya_posisi_lainnya", [
        ...
        "posisi terbaru", "update lowongan terbaru", "cek posisi terbaru",
        "info lengkap tiap posisi", "detail masing-masing posisi",
        "linktree", "sosial media resmi",
    ]),
    ("tanya_gelombang_pendaftaran", [
        ...
        "gelombang berapa yang dibuka", "masih ada gelombang gak",
        "gelombang selanjutnya kapan", "pendaftaran gelombang ini kapan ditutup",
        "kapan mulai daftar", "batch pendaftaran",
    ]),
    ("tanya_kuota_peserta", [
        "kuota", "slot magang terbatas", "kuota tiap posisi berapa orang",
        "berapa banyak yang diterima tiap posisi",
        "kuota masih ada gak", "sisa kuota berapa", "kuota per posisi berapa",
        "kuotanya terbatas gak", "banyak yang daftar gak", "slot masih kosong gak",
    ]),
    ("tanya_uang_saku", [
        "uang saku", "murni volunteer apa dibayar", "magang disini dibayar gak",
        "nominal uang sakunya",
        "gaji magang berapa", "dikasih gaji gak", "ada insentif gak",
        "dapet honor gak", "uang transport dikasih gak", "uang makan dikasih gak",
        "kompensasi magang ada gak", "ada tunjangan gak",
    ]),
    ("tanya_domisili_luar_kota", [
        ...
        "domisili luar jogja boleh daftar gak", "gak tinggal di jogja gimana",
        "harus tinggal di jogja gak", "disediain tempat tinggal gak", "ada mess gak",
    ]),
    ("tanya_mitra_kerja", [
        ...
        "partner kerja sama siapa aja", "perusahaan mitra apa aja",
        "kerja sama dengan siapa", "ditaro di client mana",
    ]),
    ("tanya_peluang_karier", [
        "direkrut jadi karyawan", "peluang karier", "peluang lanjut kerja",
        "ditawarin kerja", "lanjut kerja abis magang",
        "bisa jadi karyawan tetap gak", "peluang direkrut",
        "abis magang ditawarin kerja gak", "jenjang karier setelah magang",
    ]),
    ("tanya_evaluasi_magang", [
        "evaluasi kinerja", "ditegur gak", "dipantau sama pembimbing",
        "laporan progress", "gimana cara ngukur berhasil",
        "ada penilaian kinerja gak", "dinilai gak selama magang",
        "sistem penilaiannya gimana", "ada laporan akhir gak",
    ]),
    ("tanya_daftar_lebih_dari_satu_posisi", [
        ...
        "boleh apply lebih dari satu", "boleh coba banyak posisi",
        "gimana kalo minat di beberapa posisi",
    ]),
    ("tanya_belum_ada_pengalaman", [
        ...
        "pemula boleh daftar gak", "belum ada pengalaman kerja",
        "masih awam banget", "gapapa kan belum bisa apa-apa",
    ]),
    ("tanya_testimoni", [
        "testimoni", "kata orang-orang", "review magang jogja", "banyak yang puas",
        "ada bukti nyata gak", "pengalaman alumni gimana",
        "cerita dari peserta sebelumnya", "review dari yang udah ikut",
    ]),
    ("rekomendasi_posisi_sesuai_jurusan", [
        ...
        "bingung milih posisi", "belum tau minat di posisi apa",
        "disaranin ambil yang mana", "rekomendasi posisi buat saya",
    ]),
    ("aturan_tata_tertib", [
        ...
        "peraturan magang apa aja", "aturan yang harus ditaati",
        "sanksi kalo melanggar", "boleh gak dateng telat", "gimana kalo absen",
    ]),
    ("tanya_alat_kerja_laptop", [
        ...
        "wajib bawa laptop sendiri", "kalo gak punya laptop gimana",
        "software dikasih gak", "device kerja disediain gak",
    ]),
    ("penutup_terima_kasih", [
        "makasih", "makasi", "terima kasih", "terimakasih", "trims",
        "thanks", "thank you", "oke deh", "sip",
        "makasih banyak", "makasih ya min", "thanks min", "thanks banget",
        "makasih infonya", "sip min", "oke sip", "ok sip", "noted", "noted ya",
        "baik min", "baik kak", "mengerti", "paham min", "oke paham", "ngerti min",
    ]),
    ...
    ("tanya_info_umum_magang", [
        ...
        "magang jogja punya siapa", "siapa yang bikin magang jogja",
        "profil magang jogja", "sejarah magang jogja",
    ]),
]
